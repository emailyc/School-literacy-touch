/**
 * jspsych-chung-clickable-image
 * Yiu Chung WONG
 *
 * plugin for displaying a clickable image as response
 *
 * documentation: no documentation
 *
 **/

jsPsych.plugins["chung-clickable-image"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'chung-clickable-image',
    description: '',
    parameters: {
      stimulus: {
